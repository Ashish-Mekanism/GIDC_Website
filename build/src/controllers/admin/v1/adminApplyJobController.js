...
const getAppliedJobSeekerList = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    const fromDate = (_a = req === null || req === void 0 ? void 0 : req.query) === null || _a === void 0 ? void 0 : _a.fromDate;
    const toDate = (_b = req === null || req === void 0 ? void 0 : req.query) === null || _b === void 0 ? void 0 : _b.toDate;
    if (!userid) {
        throw new Error('User ID is required.');
    }
    const jobList = yield adminApplyJobService.getAppliedJobSeekerList({
        fromDate,
        toDate,
    });
