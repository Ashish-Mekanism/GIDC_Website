...
exports.ForeignEmbassiesService = void 0;
...
const ForeignEmbassies_1 = __importDefault(require("../../models/ForeignEmbassies"));
const path_1 = __importDefault(require("path"));
class ForeignEmbassiesService {
    constructor() {
    ...
    userId, files // Array of images
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingForeignEmbassies = yield ForeignEmbassies_1.default.findOne();
            if (existingForeignEmbassies) {
                throw new ApiError_1.default(constants_1.RESPONSE_CODE.BAD_REQUEST, "A 'Foreign Embassies' entry already exists. You cannot create another one.");
            }
            // Process uploaded images
            const foreignEmbassiesPhotos = files.map((file) => ({
                fileName: file.filename,
            }));
            // Prepare the gallery data
            const newGallery = new ForeignEmbassies_1.default({
                CreatedBy: userId,
    ...
    updateForeignEmbassies(payload, foreignEmbassiesId, files // Array of image files
    ) {
        return __awaiter(this, void 0, void 0, function* () {
            // Validate that we have a gallery id to update.
            if (!foreignEmbassiesId) {
                throw new ApiError_1.default(constants_1.RESPONSE_CODE.NOT_FOUND, "Foreign Embassies ID is required", {}, false);
            }
            // Find the gallery document by ID.
            const gallery = yield ForeignEmbassies_1.default.findById(foreignEmbassiesId);
            if (!gallery) {
                throw new ApiError_1.default(constants_1.RESPONSE_CODE.NOT_FOUND, "Foreign Embassies Not Found", {}, false);
            }
            ...
            if (deleteIds.length > 0) {
                ...
                if (deleteFileNames.length > 0) {
                    const deletePromises = deleteFileNames.map((filename) => {
                        const filePath = path_1.default.join("uploads", "foreignEmbassies", CreatedById, filename);
    ...
    getForeignEmbassies() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gallery = yield ForeignEmbassies_1.default.findOne().lean();
            if (!gallery) {
            ...
            gallery.Photos = gallery.Photos.map(photo => (Object.assign(Object.assign({}, photo), { imageUrl: this.fileService.getFilePathFromDatabase(constants_1.FOLDER_NAMES.FOREIGNEMBASSIES, [createdByIdString, photo.fileName]) })));
            return gallery;
        });
    }
}
exports.ForeignEmbassiesService = ForeignEmbassiesService;
